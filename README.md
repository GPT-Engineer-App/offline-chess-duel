...
**Project**: offline-chess-duel 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: create a 2 player chess game for me that 2 people can play offline 
...
```sh
git clone https://github.com/GPT-Engineer-App/offline-chess-duel.git
cd offline-chess-duel
npm i
